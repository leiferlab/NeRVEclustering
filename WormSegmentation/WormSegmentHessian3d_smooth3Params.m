function wormBW2=WormSegmentHessian3d_smooth3Params(worm,options)
...
smoothSize=5; % size of gaussian for smooth3
smoothSD=3; % standard dev of gaussian for smooth3
...
subIm=smooth3(subIm,'gaussian',smoothSize,smoothSD);
