function varargout = VisualizeWormDataSplit3D2(varargin)
% VISUALIZEWORMDATASPLIT3D2 MATLAB code for VisualizeWormDataSplit3D2.fig
%      VISUALIZEWORMDATASPLIT3D2, by itself, creates a new VISUALIZEWORMDATASPLIT3D2 or raises the existing
%      singleton*.
%
%      H = VISUALIZEWORMDATASPLIT3D2 returns the handle to a new VISUALIZEWORMDATASPLIT3D2 or the handle to
%      the existing singleton*.
%
%      VISUALIZEWORMDATASPLIT3D2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VISUALIZEWORMDATASPLIT3D2.M with the given input arguments.
%
%      VISUALIZEWORMDATASPLIT3D2('Property','Value',...) creates a new VISUALIZEWORMDATASPLIT3D2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before VisualizeWormDataSplit3D2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to VisualizeWormDataSplit3D2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help VisualizeWormDataSplit3D2

% Last Modified by GUIDE v2.5 03-Oct-2014 02:06:03

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @VisualizeWormDataSplit3D2_OpeningFcn, ...
    'gui_OutputFcn',  @VisualizeWormDataSplit3D2_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before VisualizeWormDataSplit3D2 is made visible.
function VisualizeWormDataSplit3D2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to VisualizeWormDataSplit3D2 (see VARARGIN)

% Choose default command line output for VisualizeWormDataSplit3D2
...
% UIWAIT makes VisualizeWormDataSplit3D2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = VisualizeWormDataSplit3D2_OutputFcn(hObject, eventdata, handles)
