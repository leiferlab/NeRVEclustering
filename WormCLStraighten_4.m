...
function [V,pointStats,Vproj,vRegion,side]=WormCLStraighten_4(dataFolder,destination,vidInfo,alignments,ctrlPoints,Vtemplate,vRegion,zOffset,iStack,side,show)
