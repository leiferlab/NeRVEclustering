function varargout = VisualizeWormDataSplit(varargin)
% VISUALIZEWORMDATASPLIT MATLAB code for VisualizeWormDataSplit.fig
%      VISUALIZEWORMDATASPLIT, by itself, creates a new VISUALIZEWORMDATASPLIT or raises the existing
%      singleton*.
%
%      H = VISUALIZEWORMDATASPLIT returns the handle to a new VISUALIZEWORMDATASPLIT or the handle to
%      the existing singleton*.
%
%      VISUALIZEWORMDATASPLIT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VISUALIZEWORMDATASPLIT.M with the given input arguments.
%
%      VISUALIZEWORMDATASPLIT('Property','Value',...) creates a new VISUALIZEWORMDATASPLIT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before VisualizeWormDataSplit_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to VisualizeWormDataSplit_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help VisualizeWormDataSplit

% Last Modified by GUIDE v2.5 20-Sep-2014 03:01:30

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @VisualizeWormDataSplit_OpeningFcn, ...
    'gui_OutputFcn',  @VisualizeWormDataSplit_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before VisualizeWormDataSplit is made visible.
function VisualizeWormDataSplit_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to VisualizeWormDataSplit (see VARARGIN)

% Choose default command line output for VisualizeWormDataSplit
...
% UIWAIT makes VisualizeWormDataSplit wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = VisualizeWormDataSplit_OutputFcn(hObject, eventdata, handles)
