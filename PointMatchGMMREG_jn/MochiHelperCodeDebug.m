...
%for scene_index = 1:size(newWormMasterPre,3)
    ...
    %for model_index = 1:size(newWormMasterPre,3)
        if scene_index ~= model_index
            ...
            [score_avgdist, match_result, Transformed_M, Transformed_S, multilevel_ctrl_pts, multilevel_param] = run_gmmreg(M, S, rigid_scene_worm, [], [], fiducial_indices, spring_constant);
