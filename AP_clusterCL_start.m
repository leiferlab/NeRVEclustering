...
fprintf('First for loop finished\n');
...
fprintf('Done w. PCA and Flash Finding part 1\n');
...
fprintf('Done w. PCA and Flash Finding part 2\n');

%
[~,score,~,~] = pca(refintensityZ');

fprintf('Done w. PCA and Flash Finding part 3\n');
...
fprintf('Done w. BG clustering part 1\n');
...
while any(frames_per_bg< 195 & frames_per_bg>0)
    counter = counter + 1;
...
fprintf('Done w. second for loop\n');
...
fprintf('Done w. fourth for loop\n');
...
fprintf('Done w. setting initial_cl\n');
