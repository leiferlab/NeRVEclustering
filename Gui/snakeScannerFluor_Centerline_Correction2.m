function varargout = snakeScannerFluor_Centerline_Correction2(varargin)
% SNAKESCANNERFLUOR_CENTERLINE_CORRECTION2 MATLAB code for snakeScannerFluor_Centerline_Correction2.fig
%      SNAKESCANNERFLUOR_CENTERLINE_CORRECTION2, by itself, creates a new SNAKESCANNERFLUOR_CENTERLINE_CORRECTION2 or raises the existing
%      singleton*.
%
%      H = SNAKESCANNERFLUOR_CENTERLINE_CORRECTION2 returns the handle to a new SNAKESCANNERFLUOR_CENTERLINE_CORRECTION2 or the handle to
%      the existing singleton*.
%
%      SNAKESCANNERFLUOR_CENTERLINE_CORRECTION2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SNAKESCANNERFLUOR_CENTERLINE_CORRECTION2.M with the given input arguments.
%
%      SNAKESCANNERFLUOR_CENTERLINE_CORRECTION2('Property','Value',...) creates a new SNAKESCANNERFLUOR_CENTERLINE_CORRECTION2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before snakeScannerFluor_Centerline_Correction2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to snakeScannerFluor_Centerline_Correction2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help snakeScannerFluor_Centerline_Correction2

% Last Modified by GUIDE v2.5 30-Oct-2014 20:42:59

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @snakeScannerFluor_Centerline_Correction2_OpeningFcn, ...
                   'gui_OutputFcn',  @snakeScannerFluor_Centerline_Correction2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before snakeScannerFluor_Centerline_Correction2 is made visible.
function snakeScannerFluor_Centerline_Correction2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to snakeScannerFluor_Centerline_Correction2 (see VARARGIN)

% Choose default command line output for snakeScannerFluor_Centerline_Correction2
...
% UIWAIT makes snakeScannerFluor_Centerline_Correction2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = snakeScannerFluor_Centerline_Correction2_OutputFcn(hObject, eventdata, handles) 
