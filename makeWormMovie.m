...
imageFolder=[dataFolder filesep 'imageMovieAllBalls2'];
...
%%
masterData=load(['E:\20141212\BrainScanner20141212_145951' filesep 'refStackStraight']);
fiducials=masterData.masterFiducials;
data=load(['E:\20141212\BrainScanner20141212_145951'  filesep 'heatData']);
...
hiResApproxIdx=linspace(frameRange(1),frameRange(end),length(wormInfo));
