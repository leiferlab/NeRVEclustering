...
if watershedFilter
Jd=-bwdist_jn(~Jm,scaleFactor);  %make distance map
...
subImaxPnts=subImaxPnts.*subIm;
subImaxPnts=imdilate(subImaxPnts*valleyRatio,true(8,8,8));
subImaxPnts(subImaxPnts==0)=Inf;
subImaxReg=subImaxPnts<subIm;
...
maxBW=watershed(bwdist_jn(subsubImax,scaleFactor));
...
wormSearch(BB(2):BB(5),BB(1):BB(4),BB(3):BB(6))=0;
wormBW2(BB(2):BB(5),BB(1):BB(4),BB(3):BB(6))=...
    or(Jm,wormBW2(BB(2):BB(5),BB(1):BB(4),BB(3):BB(6)));
% 
% 
%         
