function runTrack_track2firstFrameFiducials(imFolder,metaDataFolder)
...
Gintensities=stackData.Gintensities;%[Transformed_M, multilevel_ctrl_pts, multilevel_param] = gmmreg_L2_multilevel(centroids, centroids1, 3, [1, 0.1, 0.01], [0.00008, 0.00008, 0.00008], [0 0 0], 10);
...
trackOutput=sortrows(trackOutput,7);
